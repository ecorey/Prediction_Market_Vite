...
// When the init function runs, it creates the transfer policy and stores it in the registry which is a shared object. 
// The init also transfers the transfer policy cap and game owner cap to the sender. 
// The game owner cap can then be used to start the game and close the game.
